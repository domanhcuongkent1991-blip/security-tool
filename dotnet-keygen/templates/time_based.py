# REFERENCE-ONLY (retired per MASTER_POLICY section 2): this historical keygen template documents a weakness class for robustness audits.
# It must not be executed or distributed; the retired entry point scripts/generate_keygen.py exits without producing anything.
#!/usr/bin/env python3
