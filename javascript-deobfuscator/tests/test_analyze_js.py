...
class AnalyzeJsTests(unittest.TestCase):
    ...
    def test_redacts_secret_like_values_from_strings(self):
        analyze_js = load_module()
        # Built by concatenation so this fixture cannot itself match the Stripe
        # secret pattern (sk_live_ + 24 chars) and trip GitHub push protection.
        ...
        self.assertNotIn(fake_stripe_key, as_json)
